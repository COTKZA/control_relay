...
class DataListRealtimeScreen2 extends StatefulWidget {
  @override
  _DataListRealtimeScreenState2 createState() =>
      _DataListRealtimeScreenState2();
}

class _DataListRealtimeScreenState2 extends State<DataListRealtimeScreen2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Real-time Soil Moisture Sensor 2'),
